#!/usr/bin/env python3
"""Validate T13 preparation and perform a fail-closed T13 activation preflight."""
...
def main():
    ...
    if args.all:
        ...
        out = {"wave":"T13","mode":"preparation","results":results,"passed":all(x["passed"] for x in results)}
    else:
        if not args.task:
            raise SystemExit("use --all or --task T13")
