...
def passing_record():
    return {
        ...
        "visual_review":{"passed":True,"status":"PASS","source":T05_ACCEPTED_SOURCE,"score_averaging_used":False,"valid_unresolved_defects":[],"scores":{"C1":{"reference_fidelity":9.5},"C2":{"geometry_contact":9.5}}},
        "performance_critic":{"critic":"C6","passed":True,"coverage_complete":True,"candidate_source":T05_ACCEPTED_SOURCE,"defects":[],"scores":{"frame_time":9.1}},
