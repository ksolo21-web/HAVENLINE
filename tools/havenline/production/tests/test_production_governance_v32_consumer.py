...
class GovernanceConsumerTests(unittest.TestCase):
    ...
    def test_hostile_contract_changes_fail(self):
        ...
        for field,value in [('passed',False),('unchanged_locked_files',47),('unchanged_locked_files',45),('authorized_changes',changes[:-1]),('authorized_changes',changes+['unapproved']),('authorized_changes',list(reversed(changes))),('predecessor_accepted_source','0'*40),('predecessor_manifest_sha256','0'*64)]:
