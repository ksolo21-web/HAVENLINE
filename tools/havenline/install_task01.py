...
s=p.read_text()
assert 'const ReferenceForest = preload(' not in s,'T01 already installed; inspect rather than applying twice'
...
p.write_text(s)
print('T01 runtime applied:',hashlib.sha256(p.read_bytes()).hexdigest(),'; no art/performance approval')
