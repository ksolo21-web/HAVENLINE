...
suites = []
for name in ('test_simulation', 'test_crew_and_persistence', 'test_motion_and_performance', 'test_population', 'test_outpost', 'test_outpost_runtime', 'test_environment', 'test_render_budget', 'test_adaptive_devices'):
