...
from review_protocol import (
    BOARD_CANVAS_SIZE, CANDIDATE_PANEL_WIDTH, FILES, GROUP_FAMILIES,
...
class BoardLayoutTests(unittest.TestCase):
    def test_widest_shipping_views_clear_strict_resolution_floor(self):
        # 20:9 phone and 2.334:1 foldable-outer are the two widest shipping views.
        for source_size, height_bound in (((2400, 1080), 508), ((2400, 1028), 1058)):
            displayed = contained_display_size(source_size, (CANDIDATE_PANEL_WIDTH, height_bound))
            self.assertGreaterEqual(displayed[1], MIN_CANDIDATE_DISPLAY_HEIGHT)
