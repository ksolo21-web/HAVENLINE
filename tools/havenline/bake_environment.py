...
def shelter():
 ...
 def snowroof(u,v):
  ...
  thick=.11+.045*math.sin(x*3.1+z*2)+.025*math.cos(z*5+x)
...
def rocks(kind):
 ...
 m.features=['four lobed sculpted stones','normal-mapped mineral surfaces','snow conforms to exposed union of rocks','no buried cap intersections']
 return m
