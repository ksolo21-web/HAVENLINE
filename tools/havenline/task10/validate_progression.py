...
REQUIRED = {
    "test_task10_world_transform": {
        ...
        "advanced target requires latest completed receipt",
        "orphan restore preserves populated state atomically",
        "recipe-bound prepared rejects rekeyed debits",
        "recipe-bound receipts rejects rekeyed debits",
        "advanced receipt plus next pending roundtrips",
