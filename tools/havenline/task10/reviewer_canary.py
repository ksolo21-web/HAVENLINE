...
def main():
    ...
    a=ap.parse_args();result=dict(diagnostic_only=True,task_approved=False,reusable_for_approval=False,tool_sha=a.tool_sha,evidence_sha=EVIDENCE_SHA,evidence_run_id=RUN_ID,evidence_artifact_id=ARTIFACT_ID,evidence_archive_sha256=ARCHIVE_SHA,passed=False,errors=[])
    try:
