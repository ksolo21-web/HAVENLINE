...
print(json.dumps({'adapter':'t06-device-v2','state':state,'logical_size':[width,height],'validated':True}))
PY
...
print(json.dumps({'adapter':'t06-save-v2','case':case,'validated':True}))
PY
